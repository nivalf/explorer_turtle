...
class WallFollowerServer():
    ...
    def __init__(self):
        ...
        self.actionserver = actionlib.SimpleActionServer(
            "wall_follower_server", SearchAction, self.execute_cb, auto_start=False)
        ...
        rospy.loginfo("The 'Wall Follower Action Server' is active...")
    ...
    def execute_cb(self, goal: SearchGoal):
        try:
            ...
            print(f"\n#####\n"
                f"The 'wall_follower_server' has been called.\n"
            ...
            self.vel_controller.set_move_cmd(fwd_velocity)
...
if __name__ == '__main__':
    rospy.init_node("wall_follower_server")
    WallFollowerServer()
    rospy.spin()
